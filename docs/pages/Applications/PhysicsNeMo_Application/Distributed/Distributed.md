...
summary: MPI-aware export of fields and mesh topology, matched process groups and device meshes, the MPI test suite, halo-partitioned graph training and domain parallelism over ShardTensor across the Kratos ranks.
---
...
<p align="center">
    <img src="images/rank_layout.svg" alt="A partitioned model part and the three distributed patterns: gather to rank 0, halo-partitioned subgraphs, one ShardTensor"/>
</p>
<p align="center">Figure 1: What each rank holds, and the three things the application does across ranks.</p>

<p align="center">
    <img src="images/halo_partition.png" alt="A two-rank partition showing owned nodes, ghosts, halo elements and the interface node whose neighbourhood is truncated without the halo"/>
</p>
<p align="center">Figure 2: Why the plain graph bridge is wrong on a distributed part, and what the halo subgraph adds (generated by the figure script).</p>

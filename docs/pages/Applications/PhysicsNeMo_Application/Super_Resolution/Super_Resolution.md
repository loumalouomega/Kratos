...
summary: The grid bridge that samples unstructured fields onto voxel grids, SuperResolutionProcess from a coarse solve to a fine field, accuracy notes, and the thin-axis idiom that opens the 2-D operator zoo.
---
...
<p align="center">
    <img src="images/grid_pipeline.svg" alt="Mesh to grid to model to grid to mesh, and the thin-axis squeeze for planar cases"/>
</p>
<p align="center">Figure 1: The pipeline, and the squeeze idiom that lets a 2-D model run through the 3-D machinery.</p>

<p align="center">
    <img src="images/grid_sampling.png" alt="A nodal field on an unstructured triangle mesh sampled onto a coarse and a fine grid"/>
</p>
<p align="center">Figure 2: SampleFieldsOnGrid at two resolutions (generated by the figure script): shape-function interpolation, exact for linear fields.</p>

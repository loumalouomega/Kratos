...
summary: Tessellating any Kratos mesh into the simplices physicsnemo.mesh needs, with a provenance map that brings predictions back exactly, plus DomainMesh boundaries, mesh series export, calculus, generation, SDFs, deformation and adaptive remeshing.
---
...
<p align="center">
    <img src="images/tessellation_modes.png" alt="Hexahedra, prism and pyramid tessellated by the smallest-id diagonal rule, the original element above and its tetrahedra below"/>
</p>
<p align="center">Figure 1: Corner tessellation by the smallest-id diagonal rule (generated by the figure script from the bridge itself). Two numberings of the same hexahedron give 6 and 5 tetrahedra.</p>

<p align="center">
    <img src="images/higher_order_modes.png" alt="A curved Quadrilateral2D9 and Triangle2D6 under reduce, subdivide and curved higher-order modes"/>
</p>
<p align="center">Figure 2: The three higher-order modes on curved quadratic elements. Only curved mode follows the exact geometry, through synthetic points that are interpolated on gather and dropped on scatter-back.</p>

<p align="center">
    <img src="images/provenance_roundtrip.svg" alt="A Kratos hexahedron, its six tetrahedra, the MeshProvenanceMap fields, and the three scatter-back paths"/>
</p>
<p align="center">Figure 3: The provenance round trip. Nodal fields return exactly; cell fields are aggregated per source element; surface predictions collapse onto their parent conditions.</p>

...
Process::Pointer FindintersectEdgeometricalobjectsprocess::Create(    Model& rModel,    Parameters ThisParameters    ){    return Kratos::make_shared<FindintersectEdgeometricalobjectsprocess>(rModel, ThisParameters);}

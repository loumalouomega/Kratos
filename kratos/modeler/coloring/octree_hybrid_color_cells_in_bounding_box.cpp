...
const Parameters OctreeHybridColorCellsInBoundingBox::GetDefaultParameters() const
{
    return Parameters(R"({
...
void OctreeHybridColorCellsInBoundingBox::Apply(
    OctreeHybridMeshGeneratorModeler& rModeler,
    Parameters ColoringParameters) const
{
    ...
    ResolveBoundingBox(rModeler, ColoringParameters, "OctreeHybridColorCellsInBoundingBox", bb_min, bb_max);

...
from KratosMultiphysics.PhysicsNeMoApplication.point_cloud_inference_process import GatherPointCloudCoordinates
...
class PinnSolveProcess(Kratos.Process):
    ...
    def _GatherFieldMatrix(self, specs):
        ...
        from KratosMultiphysics.PhysicsNeMoApplication.inference_process import GatherInputFields

...
#include "custom_utilities/solid_elements_utilities.h" // Key include
...
protected:
    ...
    // Axisymmetric specifics or overrides
...
private:
    ...
    AxisymSmallDisplacement() : Element() {} // Private for serialization
};
} // namespace Kratos
